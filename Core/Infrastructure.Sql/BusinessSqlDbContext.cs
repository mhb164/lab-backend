...
public class BusinessSqlDbContext : BusinessDbContext
{
    public BusinessSqlDbContext() : base() { /* We need empty constructor dotnet ef migrations */ }
    public BusinessSqlDbContext(ILogger<BusinessSqlDbContext>? logger, string? connectionString)
